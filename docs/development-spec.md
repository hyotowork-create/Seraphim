...
- **실단가 검증 완료:** Gemini 2.5 Flash($0.30/$2.50 per 1M) · Nano Banana($0.039/장)
  대입 결과 → 텍스트 1건 ≈ ₩13, 헤비 개인 월 텍스트 원가 ≈ ₩900로 **개인 11,900원
  이익률 ~90%** 확인. 상세 산출·팩 단가·손익분기는 [`cost-model.md`](./cost-model.md) 참조.
